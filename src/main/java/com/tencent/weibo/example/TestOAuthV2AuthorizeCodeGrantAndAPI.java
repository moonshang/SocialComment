...
//	    String[] BroadcastDate = new String[]{
//	    		"06/11/2013",
//	    		"07/11/2013",
//	    		
//	    		"10/11/2013",
...
//	    };
//	    
//	    BufferedWriter bw = new BufferedWriter(new FileWriter("jiehunba.txt"));
//	    
//	    SimpleDateFormat date_format = new SimpleDateFormat("HH:mm:ss dd/MM/yyyy",Locale.CHINA);
//	    date_format.setTimeZone(TimeZone.getTimeZone("GMT+8"));
//	    long start = date_format.parse("20:00:00 06/11/2013").getTime();
//	    long end = date_format.parse("22:10:00 06/11/2013").getTime();
//	    
//	    Calendar cstart = Calendar.getInstance(Locale.CHINA);
//	    cstart.setTimeInMillis(start);
//	    
//	    Calendar cend = Calendar.getInstance(Locale.CHINA);
...
//        String type="0";
//        String op="0";
//        String starttime=String.valueOf(cstart.getTimeInMillis()/1000);
//        String endtime=String.valueOf(cend.getTimeInMillis()/1000);
//        
//        String province="";
//        String city="";
//        String longitue="";
...
//
//       response = searchAPI.t(oAuth, format, keyword, pagesize, page, contenttype, sorttype, msgtype, searchtype, starttime,endtime, province, city, longitue, latitude, radius);
...
//       	dataJsonObject=(JSONObject)responseJsonObject.get("data");
//           JSONArray info = (JSONArray)dataJsonObject.get("info");
//           for(int i = 0;i<info.size();i++){
//           	JSONObject tweet = (JSONObject)info.get(i);
//           	String text = tweet.getString("text");
//           	
//           	Date submittime = new Date();
//           	String time = tweet.getString("timestamp");
//           	System.out.println(time);
//           	submittime.setTime(Long.parseLong(time)*1000);
//           	
////           	SimpleDateFormat df = new SimpleDateFormat("EEE MMM dd HH:mm:ss z yyyy");
////           	df.setTimeZone(TimeZone.getTimeZone("GMT+8"));
////           	String beijingTime = df.format(Long.parseLong(time)*1000);
//           	
//           	int retweets = tweet.getInt("count");
//           	int comments = tweet.getInt("mcount");
//
//           	bw.write(Long.parseLong(time)*1000+"@@@"+retweets+"@@@"+comments+"@@@"+text);
//           	bw.newLine();
//           	bw.flush();
//           }
//           
...
//---------------------------------------------- 以下为测试辅助方法------------------------------------------------	
    ...
    private static void init(OAuthV2 oAuth) {
        ...
        oAuth.setOpenkey("2F25EAA50D40B30D52764A8974692172");
